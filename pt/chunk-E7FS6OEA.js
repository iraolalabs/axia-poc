...
`],encapsulation:2,changeDetection:0});}return i;})(),en=class i{_target;_ngZone;_platform;_containerElement;_triggerElement=null;_isPointerDown=!1;_activeRipples=new Map();_mostRecentTransientRipple=null;_lastTouchStartEvent;_pointerUpEventsRegistered=!1;_containerRect=null;static _eventManager=new qi();constructor(n,e,t,r,o){this._target=n,this._ngZone=e,this._platform=r,r.isBrowser&&(this._containerElement=Oe(t)),o&&o.get(ve).load(Ws);}fadeInRipple(n,e,t={}){let r=this._containerRect=this._containerRect||this._containerElement.getBoundingClientRect(),o=b(b({},Jt),t.animation);t.centered&&(n=r.left+r.width/2,e=r.top+r.height/2);let a=t.radius||Hs(n,e,r),l=n-r.left,d=e-r.top,c=o.enterDuration,m=document.createElement("div");m.classList.add("mat-ripple-element"),m.style.left=`${l-a}px`,m.style.top=`${d-a}px`,m.style.height=`${a*2}px`,m.style.width=`${a*2}px`,t.color!=null&&(m.style.backgroundColor=t.color),m.style.transitionDuration=`${c}ms`,this._containerElement.appendChild(m);let f=window.getComputedStyle(m),I=f.transitionProperty,$=f.transitionDuration,ee=I==="none"||$==="0s"||$==="0s, 0s"||r.width===0&&r.height===0,Z=new Xi(this,m,t,ee);m.style.transform="scale3d(1, 1, 1)",Z.state=xe.FADING_IN,t.persistent||(this._mostRecentTransientRipple=Z);let Ye=null;return!ee&&(c||o.exitDuration)&&this._ngZone.runOutsideAngular(()=>{let Cr=()=>{Ye&&(Ye.fallbackTimer=null),clearTimeout(wr),this._finishRippleTransition(Z);},xi=()=>this._destroyRipple(Z),wr=setTimeout(xi,c+100);m.addEventListener("transitionend",Cr),m.addEventListener("transitioncancel",xi),Ye={onTransitionEnd:Cr,onTransitionCancel:xi,fallbackTimer:wr};}),this._activeRipples.set(Z,Ye),(ee||!c)&&this._finishRippleTransition(Z),Z;}fadeOutRipple(n){if(n.state===xe.FADING_OUT||n.state===xe.HIDDEN)return;let e=n.element,t=b(b({},Jt),n.config.animation);e.style.transitionDuration=`${t.exitDuration}ms`,e.style.opacity="0",n.state=xe.FADING_OUT,(n._animationForciblyDisabledThroughCss||!t.exitDuration)&&this._finishRippleTransition(n);}fadeOutAll(){this._getActiveRipples().forEach(n=>n.fadeOut());}fadeOutAllNonPersistent(){this._getActiveRipples().forEach(n=>{n.config.persistent||n.fadeOut();});}setupTriggerEvents(n){let e=Oe(n);!this._platform.isBrowser||!e||e===this._triggerElement||(this._removeTriggerEvents(),this._triggerElement=e,Ho.forEach(t=>{i._eventManager.addHandler(this._ngZone,t,e,this);}));}handleEvent(n){n.type==="mousedown"?this._onMousedown(n):n.type==="touchstart"?this._onTouchStart(n):this._onPointerUp(),this._pointerUpEventsRegistered||(this._ngZone.runOutsideAngular(()=>{Uo.forEach(e=>{this._triggerElement.addEventListener(e,this,Wo);});}),this._pointerUpEventsRegistered=!0);}_finishRippleTransition(n){n.state===xe.FADING_IN?this._startFadeOutTransition(n):n.state===xe.FADING_OUT&&this._destroyRipple(n);}_startFadeOutTransition(n){let e=n===this._mostRecentTransientRipple,{persistent:t}=n.config;n.state=xe.VISIBLE,!t&&(!e||!this._isPointerDown)&&n.fadeOut();}_destroyRipple(n){let e=this._activeRipples.get(n)??null;this._activeRipples.delete(n),this._activeRipples.size||(this._containerRect=null),n===this._mostRecentTransientRipple&&(this._mostRecentTransientRipple=null),n.state=xe.HIDDEN,e!==null&&(n.element.removeEventListener("transitionend",e.onTransitionEnd),n.element.removeEventListener("transitioncancel",e.onTransitionCancel),e.fallbackTimer!==null&&clearTimeout(e.fallbackTimer)),n.element.remove();}_onMousedown(n){let e=Ze(n),t=this._lastTouchStartEvent&&Date.now()<this._lastTouchStartEvent+Gs;!this._target.rippleDisabled&&!e&&!t&&(this._isPointerDown=!0,this.fadeInRipple(n.clientX,n.clientY,this._target.rippleConfig));}_onTouchStart(n){if(!this._target.rippleDisabled&&!Qe(n)){this._lastTouchStartEvent=Date.now(),this._isPointerDown=!0;let e=n.changedTouches;if(e)for(let t=0;t<e.length;t++)this.fadeInRipple(e[t].clientX,e[t].clientY,this._target.rippleConfig);}}_onPointerUp(){this._isPointerDown&&(this._isPointerDown=!1,this._getActiveRipples().forEach(n=>{let e=n.state===xe.VISIBLE||n.config.terminateOnPointerUp&&n.state===xe.FADING_IN;!n.config.persistent&&e&&n.fadeOut();}));}_getActiveRipples(){return Array.from(this._activeRipples.keys());}_removeTriggerEvents(){let n=this._triggerElement;n&&(Ho.forEach(e=>i._eventManager.removeHandler(e,n,this)),this._pointerUpEventsRegistered&&(Uo.forEach(e=>n.removeEventListener(e,this,Wo)),this._pointerUpEventsRegistered=!1));}};function Hs(i,n,e){let t=Math.max(Math.abs(i-e.left),Math.abs(i-e.right)),r=Math.max(Math.abs(n-e.top),Math.abs(n-e.bottom));return Math.sqrt(t*t+r*r);}var Ki=new g("mat-ripple-global-options"),$n=(()=>{class i{_elementRef=s(S);_animationsDisabled=se();color;unbounded=!1;centered=!1;radius=0;animation;get disabled(){return this._disabled;}set disabled(e){e&&this.fadeOutAllNonPersistent(),this._disabled=e,this._setupTriggerEventsIfEnabled();}_disabled=!1;get trigger(){return this._trigger||this._elementRef.nativeElement;}set trigger(e){this._trigger=e,this._setupTriggerEventsIfEnabled();}_trigger;_rippleRenderer;_globalOptions;_isInitialized=!1;constructor(){let e=s(P),t=s(q),r=s(Ki,{optional:!0}),o=s(H);this._globalOptions=r||{},this._rippleRenderer=new en(this,e,this._elementRef,t,o);}ngOnInit(){this._isInitialized=!0,this._setupTriggerEventsIfEnabled();}ngOnDestroy(){this._rippleRenderer._removeTriggerEvents();}fadeOutAll(){this._rippleRenderer.fadeOutAll();}fadeOutAllNonPersistent(){this._rippleRenderer.fadeOutAllNonPersistent();}get rippleConfig(){return{centered:this.centered,radius:this.radius,color:this.color,animation:b(b(b({},this._globalOptions.animation),this._animationsDisabled?{enterDuration:0,exitDuration:0}:{}),this.animation),terminateOnPointerUp:this._globalOptions.terminateOnPointerUp};}get rippleDisabled(){return this.disabled||!!this._globalOptions.disabled;}_setupTriggerEventsIfEnabled(){!this.disabled&&this._isInitialized&&this._rippleRenderer.setupTriggerEvents(this.trigger);}launch(e,t=0,r){return typeof e=="number"?this._rippleRenderer.fadeInRipple(e,t,b(b({},this.rippleConfig),r)):this._rippleRenderer.fadeInRipple(0,0,b(b({},this.rippleConfig),e));}static ɵfac=function(t){return new(t||i)();};static ɵdir=F({type:i,selectors:[["","mat-ripple",""],["","matRipple",""]],hostAttrs:[1,"mat-ripple"],hostVars:2,hostBindings:function(t,r){t&2&&A("mat-ripple-unbounded",r.unbounded);},inputs:{color:[0,"matRippleColor","color"],unbounded:[0,"matRippleUnbounded","unbounded"],centered:[0,"matRippleCentered","centered"],radius:[0,"matRippleRadius","radius"],animation:[0,"matRippleAnimation","animation"],disabled:[0,"matRippleDisabled","disabled"],trigger:[0,"matRippleTrigger","trigger"]},exportAs:["matRipple"]});}return i;})();var Us={capture:!0},$s=["focus","mousedown","mouseenter","touchstart"],Zi="mat-ripple-loader-uninitialized",Qi="mat-ripple-loader-class-name",$o="mat-ripple-loader-centered",Yn="mat-ripple-loader-disabled",Yo=(()=>{class i{_document=s(G);_animationsDisabled=se();_globalRippleOptions=s(Ki,{optional:!0});_platform=s(q);_ngZone=s(P);_injector=s(H);_eventCleanups;_hosts=new Map();constructor(){let e=s(we).createRenderer(null,null);this._eventCleanups=this._ngZone.runOutsideAngular(()=>$s.map(t=>e.listen(this._document,t,this._onInteraction,Us)));}ngOnDestroy(){let e=this._hosts.keys();for(let t of e)this.destroyRipple(t);this._eventCleanups.forEach(t=>t());}configureRipple(e,t){e.setAttribute(Zi,this._globalRippleOptions?.namespace??""),(t.className||!e.hasAttribute(Qi))&&e.setAttribute(Qi,t.className||""),t.centered&&e.setAttribute($o,""),t.disabled&&e.setAttribute(Yn,"");}setDisabled(e,t){let r=this._hosts.get(e);r?(r.target.rippleDisabled=t,!t&&!r.hasSetUpEvents&&(r.hasSetUpEvents=!0,r.renderer.setupTriggerEvents(e))):t?e.setAttribute(Yn,""):e.removeAttribute(Yn);}_onInteraction=e=>{let t=oe(e);if(t instanceof HTMLElement){let r=t.closest(`[${Zi}="${this._globalRippleOptions?.namespace??""}"]`);r&&this._createRipple(r);}};_createRipple(e){if(!this._document||this._hosts.has(e))return;e.querySelector(".mat-ripple")?.remove();let t=this._document.createElement("span");t.classList.add("mat-ripple",e.getAttribute(Qi)),e.append(t);let r=this._globalRippleOptions,o=this._animationsDisabled?0:r?.animation?.enterDuration??Jt.enterDuration,a=this._animationsDisabled?0:r?.animation?.exitDuration??Jt.exitDuration,l={rippleDisabled:this._animationsDisabled||r?.disabled||e.hasAttribute(Yn),rippleConfig:{centered:e.hasAttribute($o),terminateOnPointerUp:r?.terminateOnPointerUp,animation:{enterDuration:o,exitDuration:a}}},d=new en(l,this._ngZone,t,this._platform,this._injector),c=!l.rippleDisabled;c&&d.setupTriggerEvents(e),this._hosts.set(e,{target:l,renderer:d,hasSetUpEvents:c}),e.removeAttribute(Zi);}destroyRipple(e){let t=this._hosts.get(e);t&&(t.renderer._removeTriggerEvents(),this._hosts.delete(e));}static ɵfac=function(t){return new(t||i)();};static ɵprov=_({token:i,factory:i.ɵfac,providedIn:"root"});}return i;})();var Ct=(()=>{class i{static ɵfac=function(t){return new(t||i)();};static ɵcmp=v({type:i,selectors:[["structural-styles"]],decls:0,vars:0,template:function(t,r){},styles:[`.mat-focus-indicator {
  position: relative;
}
...
`],encapsulation:2,changeDetection:0});}return i;})();var Ks=new g("cdk-dir-doc",{providedIn:"root",factory:()=>s(G)}),Zs=/^(ar|ckb|dv|he|iw|fa|nqo|ps|sd|ug|ur|yi|.*[-_](Adlm|Arab|Hebr|Nkoo|Rohg|Thaa))(?!.*[-_](Latn|Cyrl)($|-|_))($|-|_)/i;function qo(i){let n=i?.toLowerCase()||"";return n==="auto"&&typeof navigator<"u"&&navigator?.language?Zs.test(navigator.language)?"rtl":"ltr":n==="rtl"?"rtl":"ltr";}var Pe=(()=>{class i{get value(){return this.valueSignal();}valueSignal=Y("ltr");change=new R();constructor(){let e=s(Ks,{optional:!0});if(e){let t=e.body?e.body.dir:null,r=e.documentElement?e.documentElement.dir:null;this.valueSignal.set(qo(t||r||"ltr"));}}ngOnDestroy(){this.change.complete();}static ɵfac=function(t){return new(t||i)();};static ɵprov=_({token:i,factory:i.ɵfac,providedIn:"root"});}return i;})();var B=(()=>{class i{static ɵfac=function(t){return new(t||i)();};static ɵmod=M({type:i});static ɵinj=w({});}return i;})();var wt=(()=>{class i{static ɵfac=function(t){return new(t||i)();};static ɵmod=M({type:i});static ɵinj=w({imports:[B]});}return i;})();var Qs=["matButton",""],Js=[[["",8,"material-icons",3,"iconPositionEnd",""],["mat-icon",3,"iconPositionEnd",""],["","matButtonIcon","",3,"iconPositionEnd",""]],"*",[["","iconPositionEnd","",8,"material-icons"],["mat-icon","iconPositionEnd",""],["","matButtonIcon","","iconPositionEnd",""]]],el=[".material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])","*",".material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]"];var Ko=new Map([["text",["mat-mdc-button"]],["filled",["mdc-button--unelevated","mat-mdc-unelevated-button"]],["elevated",["mdc-button--raised","mat-mdc-raised-button"]],["outlined",["mdc-button--outlined","mat-mdc-outlined-button"]],["tonal",["mat-tonal-button"]]]),Zo=(()=>{class i extends Ji{get appearance(){return this._appearance;}set appearance(e){this.setAppearance(e||this._config?.defaultAppearance||"text");}_appearance=null;constructor(){super();let e=tl(this._elementRef.nativeElement);e&&this.setAppearance(e);}setAppearance(e){if(e===this._appearance)return;let t=this._elementRef.nativeElement.classList,r=this._appearance?Ko.get(this._appearance):null,o=Ko.get(e);r&&t.remove(...r),t.add(...o),this._appearance=e;}static ɵfac=function(t){return new(t||i)();};static ɵcmp=v({type:i,selectors:[["button","matButton",""],["a","matButton",""],["button","mat-button",""],["button","mat-raised-button",""],["button","mat-flat-button",""],["button","mat-stroked-button",""],["a","mat-button",""],["a","mat-raised-button",""],["a","mat-flat-button",""],["a","mat-stroked-button",""]],hostAttrs:[1,"mdc-button"],inputs:{appearance:[0,"matButton","appearance"]},exportAs:["matButton","matAnchor"],features:[_e],attrs:Qs,ngContentSelectors:el,decls:7,vars:4,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(t,r){t&1&&(X(Js),Ae(0,"span",0),k(1),De(2,"span",1),k(3,1),Te(),k(4,2),Ae(5,"span",2)(6,"span",3)),t&2&&A("mdc-button__ripple",!r._isFab)("mdc-fab__ripple",r._isFab);},styles:[`.mat-mdc-button-base {
  text-decoration: none;
}
...
`],encapsulation:2,changeDetection:0});}return i;})();function tl(i){return i.hasAttribute("mat-raised-button")?"elevated":i.hasAttribute("mat-stroked-button")?"outlined":i.hasAttribute("mat-flat-button")?"filled":i.hasAttribute("mat-button")?"text":null;}var Xn=(()=>{class i{static ɵfac=function(t){return new(t||i)();};static ɵmod=M({type:i});static ɵinj=w({imports:[wt,B]});}return i;})();var nl=["*"];var il=new g("MAT_CARD_CONFIG"),Jo=(()=>{class i{appearance;constructor(){let e=s(il,{optional:!0});this.appearance=e?.appearance||"raised";}static ɵfac=function(t){return new(t||i)();};static ɵcmp=v({type:i,selectors:[["mat-card"]],hostAttrs:[1,"mat-mdc-card","mdc-card"],hostVars:8,hostBindings:function(t,r){t&2&&A("mat-mdc-card-outlined",r.appearance==="outlined")("mdc-card--outlined",r.appearance==="outlined")("mat-mdc-card-filled",r.appearance==="filled")("mdc-card--filled",r.appearance==="filled");},inputs:{appearance:"appearance"},exportAs:["matCard"],ngContentSelectors:nl,decls:1,vars:0,template:function(t,r){t&1&&(X(),k(0));},styles:[`.mat-mdc-card {
  display: flex;
...
`],encapsulation:2,changeDetection:0});}return i;})();var di=(()=>{class i{static ɵfac=function(t){return new(t||i)();};static ɵmod=M({type:i});static ɵinj=w({imports:[B]});}return i;})();var Rl=["*",[["mat-toolbar-row"]]],Fl=["*","mat-toolbar-row"],Tl=(()=>{class i{static ɵfac=function(t){return new(t||i)();};static ɵdir=F({type:i,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]});}return i;})(),Ra=(()=>{class i{_elementRef=s(S);_platform=s(q);_document=s(G);color;_toolbarRows;constructor(){}ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()));}_checkToolbarMixedModes(){this._toolbarRows.length;}static ɵfac=function(t){return new(t||i)();};static ɵcmp=v({type:i,selectors:[["mat-toolbar"]],contentQueries:function(t,r,o){if(t&1&&He(o,Tl,5),t&2){let a;E(a=D())&&(r._toolbarRows=a);}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(t,r){t&2&&(be(r.color?"mat-"+r.color:""),A("mat-toolbar-multiple-rows",r._toolbarRows.length>0)("mat-toolbar-single-row",r._toolbarRows.length===0));},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:Fl,decls:2,vars:0,template:function(t,r){t&1&&(X(Rl),k(0),k(1,1));},styles:[`.mat-toolbar {
...
`],encapsulation:2,changeDetection:0});}return i;})();var Fa=(()=>{class i{static ɵfac=function(t){return new(t||i)();};static ɵmod=M({type:i});static ɵinj=w({imports:[B]});}return i;})();var dr=class{_box;_destroyed=new C();_resizeSubject=new C();_resizeObserver;_elementObservables=new Map();constructor(n){this._box=n,typeof ResizeObserver<"u"&&(this._resizeObserver=new ResizeObserver(e=>this._resizeSubject.next(e)));}observe(n){return this._elementObservables.has(n)||this._elementObservables.set(n,new st(e=>{let t=this._resizeSubject.subscribe(e);return this._resizeObserver?.observe(n,{box:this._box}),()=>{this._resizeObserver?.unobserve(n),t.unsubscribe(),this._elementObservables.delete(n);};}).pipe(ne(e=>e.some(t=>t.target===n)),Re({bufferSize:1,refCount:!0}),re(this._destroyed))),this._elementObservables.get(n);}destroy(){this._destroyed.next(),this._destroyed.complete(),this._resizeSubject.complete(),this._elementObservables.clear();}},Ta=(()=>{class i{_cleanupErrorListener;_observers=new Map();_ngZone=s(P);constructor(){typeof ResizeObserver<"u";}ngOnDestroy(){for(let[,e]of this._observers)e.destroy();this._observers.clear(),this._cleanupErrorListener?.();}observe(e,t){let r=t?.box||"content-box";return this._observers.has(r)||this._observers.set(r,new dr(r)),this._observers.get(r).observe(e);}static ɵfac=function(t){return new(t||i)();};static ɵprov=_({token:i,factory:i.ɵfac,providedIn:"root"});}return i;})();var Ll=["notch"],Vl=["matFormFieldNotchedOutline",""],Bl=["*"],Na=["iconPrefixContainer"],La=["textPrefixContainer"],Va=["iconSuffixContainer"],Ba=["textSuffixContainer"],zl=["textField"],jl=["*",[["mat-label"]],[["","matPrefix",""],["","matIconPrefix",""]],[["","matTextPrefix",""]],[["","matTextSuffix",""]],[["","matSuffix",""],["","matIconSuffix",""]],[["mat-error"],["","matError",""]],[["mat-hint",3,"align","end"]],[["mat-hint","align","end"]]],Gl=["*","mat-label","[matPrefix], [matIconPrefix]","[matTextPrefix]","[matTextSuffix]","[matSuffix], [matIconSuffix]","mat-error, [matError]","mat-hint:not([align='end'])","mat-hint[align='end']"];function Wl(i,n){i&1&&W(0,"span",21);}function Hl(i,n){if(i&1&&(u(0,"label",20),k(1,1),N(2,Wl,1,0,"span",21),h()),i&2){let e=x(2);V("floating",e._shouldLabelFloat())("monitorResize",e._hasOutline())("id",e._labelId),T("for",e._control.disableAutomaticLabeling?null:e._control.id),p(2),L(!e.hideRequiredMarker&&e._control.required?2:-1);}}function Ul(i,n){if(i&1&&N(0,Hl,3,5,"label",20),i&2){let e=x();L(e._hasFloatingLabel()?0:-1);}}function $l(i,n){i&1&&W(0,"div",7);}function Yl(i,n){}function Xl(i,n){if(i&1&&We(0,Yl,0,0,"ng-template",13),i&2){x(2);let e=Le(1);V("ngTemplateOutlet",e);}}function ql(i,n){if(i&1&&(u(0,"div",9),N(1,Xl,1,1,null,13),h()),i&2){let e=x();V("matFormFieldNotchedOutlineOpen",e._shouldLabelFloat()),p(),L(e._forceDisplayInfixLabel()?-1:1);}}function Kl(i,n){i&1&&(u(0,"div",10,2),k(2,2),h());}function Zl(i,n){i&1&&(u(0,"div",11,3),k(2,3),h());}function Ql(i,n){}function Jl(i,n){if(i&1&&We(0,Ql,0,0,"ng-template",13),i&2){x();let e=Le(1);V("ngTemplateOutlet",e);}}function ec(i,n){i&1&&(u(0,"div",14,4),k(2,4),h());}function tc(i,n){i&1&&(u(0,"div",15,5),k(2,5),h());}function nc(i,n){i&1&&W(0,"div",16);}function ic(i,n){i&1&&(u(0,"div",18),k(1,6),h());}function rc(i,n){if(i&1&&(u(0,"mat-hint",22),j(1),h()),i&2){let e=x(2);V("id",e._hintLabelId),p(),me(e.hintLabel);}}function oc(i,n){if(i&1&&(u(0,"div",19),N(1,rc,2,2,"mat-hint",22),k(2,7),W(3,"div",23),k(4,8),h()),i&2){let e=x();p(),L(e.hintLabel?1:-1);}}var dn=(()=>{class i{static ɵfac=function(t){return new(t||i)();};static ɵdir=F({type:i,selectors:[["mat-label"]]});}return i;})(),ac=new g("MatError");var mr=(()=>{class i{align="start";id=s(pe).getId("mat-mdc-hint-");static ɵfac=function(t){return new(t||i)();};static ɵdir=F({type:i,selectors:[["mat-hint"]],hostAttrs:[1,"mat-mdc-form-field-hint","mat-mdc-form-field-bottom-align"],hostVars:4,hostBindings:function(t,r){t&2&&(ft("id",r.id),T("align",null),A("mat-mdc-form-field-hint-end",r.align==="end"));},inputs:{align:"align",id:"id"}});}return i;})(),sc=new g("MatPrefix");var lc=new g("MatSuffix");var $a=new g("FloatingLabelParent"),za=(()=>{class i{_elementRef=s(S);get floating(){return this._floating;}set floating(e){this._floating=e,this.monitorResize&&this._handleResize();}_floating=!1;get monitorResize(){return this._monitorResize;}set monitorResize(e){this._monitorResize=e,this._monitorResize?this._subscribeToResize():this._resizeSubscription.unsubscribe();}_monitorResize=!1;_resizeObserver=s(Ta);_ngZone=s(P);_parent=s($a);_resizeSubscription=new te();constructor(){}ngOnDestroy(){this._resizeSubscription.unsubscribe();}getWidth(){return cc(this._elementRef.nativeElement);}get element(){return this._elementRef.nativeElement;}_handleResize(){setTimeout(()=>this._parent._handleLabelResized());}_subscribeToResize(){this._resizeSubscription.unsubscribe(),this._ngZone.runOutsideAngular(()=>{this._resizeSubscription=this._resizeObserver.observe(this._elementRef.nativeElement,{box:"border-box"}).subscribe(()=>this._handleResize());});}static ɵfac=function(t){return new(t||i)();};static ɵdir=F({type:i,selectors:[["label","matFormFieldFloatingLabel",""]],hostAttrs:[1,"mdc-floating-label","mat-mdc-floating-label"],hostVars:2,hostBindings:function(t,r){t&2&&A("mdc-floating-label--float-above",r.floating);},inputs:{floating:"floating",monitorResize:"monitorResize"}});}return i;})();function cc(i){let n=i;if(n.offsetParent!==null)return n.scrollWidth;let e=n.cloneNode(!0);e.style.setProperty("position","absolute"),e.style.setProperty("transform","translate(-9999px, -9999px)"),document.documentElement.appendChild(e);let t=e.scrollWidth;return e.remove(),t;}var ja="mdc-line-ripple--active",mi="mdc-line-ripple--deactivating",Ga=(()=>{class i{_elementRef=s(S);_cleanupTransitionEnd;constructor(){let e=s(P),t=s(ge);e.runOutsideAngular(()=>{this._cleanupTransitionEnd=t.listen(this._elementRef.nativeElement,"transitionend",this._handleTransitionEnd);});}activate(){let e=this._elementRef.nativeElement.classList;e.remove(mi),e.add(ja);}deactivate(){this._elementRef.nativeElement.classList.add(mi);}_handleTransitionEnd=e=>{let t=this._elementRef.nativeElement.classList,r=t.contains(mi);e.propertyName==="opacity"&&r&&t.remove(ja,mi);};ngOnDestroy(){this._cleanupTransitionEnd();}static ɵfac=function(t){return new(t||i)();};static ɵdir=F({type:i,selectors:[["div","matFormFieldLineRipple",""]],hostAttrs:[1,"mdc-line-ripple"]});}return i;})(),Wa=(()=>{class i{_elementRef=s(S);_ngZone=s(P);open=!1;_notch;ngAfterViewInit(){let e=this._elementRef.nativeElement,t=e.querySelector(".mdc-floating-label");t?(e.classList.add("mdc-notched-outline--upgraded"),typeof requestAnimationFrame=="function"&&(t.style.transitionDuration="0s",this._ngZone.runOutsideAngular(()=>{requestAnimationFrame(()=>t.style.transitionDuration="");}))):e.classList.add("mdc-notched-outline--no-label");}_setNotchWidth(e){let t=this._notch.nativeElement;!this.open||!e?t.style.width="":t.style.width=`calc(${e}px * var(--mat-mdc-form-field-floating-label-scale, 0.75) + 9px)`;}_setMaxWidth(e){this._notch.nativeElement.style.setProperty("--mat-form-field-notch-max-width",`calc(100% - ${e}px)`);}static ɵfac=function(t){return new(t||i)();};static ɵcmp=v({type:i,selectors:[["div","matFormFieldNotchedOutline",""]],viewQuery:function(t,r){if(t&1&&de(Ll,5),t&2){let o;E(o=D())&&(r._notch=o.first);}},hostAttrs:[1,"mdc-notched-outline"],hostVars:2,hostBindings:function(t,r){t&2&&A("mdc-notched-outline--notched",r.open);},inputs:{open:[0,"matFormFieldNotchedOutlineOpen","open"]},attrs:Vl,ngContentSelectors:Bl,decls:5,vars:0,consts:[["notch",""],[1,"mat-mdc-notch-piece","mdc-notched-outline__leading"],[1,"mat-mdc-notch-piece","mdc-notched-outline__notch"],[1,"mat-mdc-notch-piece","mdc-notched-outline__trailing"]],template:function(t,r){t&1&&(X(),Ae(0,"div",1),De(1,"div",2,0),k(3),Te(),Ae(4,"div",3));},encapsulation:2,changeDetection:0});}return i;})(),ur=(()=>{class i{value=null;stateChanges;id;placeholder;ngControl=null;focused=!1;empty=!1;shouldLabelFloat=!1;required=!1;disabled=!1;errorState=!1;controlType;autofilled;userAriaDescribedBy;disableAutomaticLabeling;describedByIds;static ɵfac=function(t){return new(t||i)();};static ɵdir=F({type:i});}return i;})();var hr=new g("MatFormField"),dc=new g("MAT_FORM_FIELD_DEFAULT_OPTIONS"),Ha="fill",mc="auto",Ua="fixed",uc="translateY(-50%)",ui=(()=>{class i{_elementRef=s(S);_changeDetectorRef=s(he);_platform=s(q);_idGenerator=s(pe);_ngZone=s(P);_defaults=s(dc,{optional:!0});_currentDirection;_textField;_iconPrefixContainer;_textPrefixContainer;_iconSuffixContainer;_textSuffixContainer;_floatingLabel;_notchedOutline;_lineRipple;_iconPrefixContainerSignal=Bt("iconPrefixContainer");_textPrefixContainerSignal=Bt("textPrefixContainer");_iconSuffixContainerSignal=Bt("iconSuffixContainer");_textSuffixContainerSignal=Bt("textSuffixContainer");_prefixSuffixContainers=ke(()=>[this._iconPrefixContainerSignal(),this._textPrefixContainerSignal(),this._iconSuffixContainerSignal(),this._textSuffixContainerSignal()].map(e=>e?.nativeElement).filter(e=>e!==void 0));_formFieldControl;_prefixChildren;_suffixChildren;_errorChildren;_hintChildren;_labelChild=$r(dn);get hideRequiredMarker(){return this._hideRequiredMarker;}set hideRequiredMarker(e){this._hideRequiredMarker=jo(e);}_hideRequiredMarker=!1;color="primary";get floatLabel(){return this._floatLabel||this._defaults?.floatLabel||mc;}set floatLabel(e){e!==this._floatLabel&&(this._floatLabel=e,this._changeDetectorRef.markForCheck());}_floatLabel;get appearance(){return this._appearanceSignal();}set appearance(e){let t=e||this._defaults?.appearance||Ha;this._appearanceSignal.set(t);}_appearanceSignal=Y(Ha);get subscriptSizing(){return this._subscriptSizing||this._defaults?.subscriptSizing||Ua;}set subscriptSizing(e){this._subscriptSizing=e||this._defaults?.subscriptSizing||Ua;}_subscriptSizing=null;get hintLabel(){return this._hintLabel;}set hintLabel(e){this._hintLabel=e,this._processHints();}_hintLabel="";_hasIconPrefix=!1;_hasTextPrefix=!1;_hasIconSuffix=!1;_hasTextSuffix=!1;_labelId=this._idGenerator.getId("mat-mdc-form-field-label-");_hintLabelId=this._idGenerator.getId("mat-mdc-hint-");_describedByIds;get _control(){return this._explicitFormFieldControl||this._formFieldControl;}set _control(e){this._explicitFormFieldControl=e;}_destroyed=new C();_isFocused=null;_explicitFormFieldControl;_previousControl=null;_previousControlValidatorFn=null;_stateChanges;_valueChanges;_describedByChanges;_outlineLabelOffsetResizeObserver=null;_animationsDisabled=se();constructor(){let e=this._defaults,t=s(Pe);e&&(e.appearance&&(this.appearance=e.appearance),this._hideRequiredMarker=!!e?.hideRequiredMarker,e.color&&(this.color=e.color)),ut(()=>this._currentDirection=t.valueSignal()),this._syncOutlineLabelOffset();}ngAfterViewInit(){this._updateFocusState(),this._animationsDisabled||this._ngZone.runOutsideAngular(()=>{setTimeout(()=>{this._elementRef.nativeElement.classList.add("mat-form-field-animations-enabled");},300);}),this._changeDetectorRef.detectChanges();}ngAfterContentInit(){this._assertFormFieldControl(),this._initializeSubscript(),this._initializePrefixAndSuffix();}ngAfterContentChecked(){this._assertFormFieldControl(),this._control!==this._previousControl&&(this._initializeControl(this._previousControl),this._control.ngControl&&this._control.ngControl.control&&(this._previousControlValidatorFn=this._control.ngControl.control.validator),this._previousControl=this._control),this._control.ngControl&&this._control.ngControl.control&&this._control.ngControl.control.validator!==this._previousControlValidatorFn&&this._changeDetectorRef.markForCheck();}ngOnDestroy(){this._outlineLabelOffsetResizeObserver?.disconnect(),this._stateChanges?.unsubscribe(),this._valueChanges?.unsubscribe(),this._describedByChanges?.unsubscribe(),this._destroyed.next(),this._destroyed.complete();}getLabelId=ke(()=>this._hasFloatingLabel()?this._labelId:null);getConnectedOverlayOrigin(){return this._textField||this._elementRef;}_animateAndLockLabel(){this._hasFloatingLabel()&&(this.floatLabel="always");}_initializeControl(e){let t=this._control,r="mat-mdc-form-field-type-";e&&this._elementRef.nativeElement.classList.remove(r+e.controlType),t.controlType&&this._elementRef.nativeElement.classList.add(r+t.controlType),this._stateChanges?.unsubscribe(),this._stateChanges=t.stateChanges.subscribe(()=>{this._updateFocusState(),this._changeDetectorRef.markForCheck();}),this._describedByChanges?.unsubscribe(),this._describedByChanges=t.stateChanges.pipe(ie([void 0,void 0]),U(()=>[t.errorState,t.userAriaDescribedBy]),Mi(),ne(([[o,a],[l,d]])=>o!==l||a!==d)).subscribe(()=>this._syncDescribedByIds()),this._valueChanges?.unsubscribe(),t.ngControl&&t.ngControl.valueChanges&&(this._valueChanges=t.ngControl.valueChanges.pipe(re(this._destroyed)).subscribe(()=>this._changeDetectorRef.markForCheck()));}_checkPrefixAndSuffixTypes(){this._hasIconPrefix=!!this._prefixChildren.find(e=>!e._isText),this._hasTextPrefix=!!this._prefixChildren.find(e=>e._isText),this._hasIconSuffix=!!this._suffixChildren.find(e=>!e._isText),this._hasTextSuffix=!!this._suffixChildren.find(e=>e._isText);}_initializePrefixAndSuffix(){this._checkPrefixAndSuffixTypes(),Se(this._prefixChildren.changes,this._suffixChildren.changes).subscribe(()=>{this._checkPrefixAndSuffixTypes(),this._changeDetectorRef.markForCheck();});}_initializeSubscript(){this._hintChildren.changes.subscribe(()=>{this._processHints(),this._changeDetectorRef.markForCheck();}),this._errorChildren.changes.subscribe(()=>{this._syncDescribedByIds(),this._changeDetectorRef.markForCheck();}),this._validateHints(),this._syncDescribedByIds();}_assertFormFieldControl(){this._control;}_updateFocusState(){let e=this._control.focused;e&&!this._isFocused?(this._isFocused=!0,this._lineRipple?.activate()):!e&&(this._isFocused||this._isFocused===null)&&(this._isFocused=!1,this._lineRipple?.deactivate()),this._elementRef.nativeElement.classList.toggle("mat-focused",e),this._textField?.nativeElement.classList.toggle("mdc-text-field--focused",e);}_syncOutlineLabelOffset(){Yr({earlyRead:()=>{if(this._appearanceSignal()!=="outline")return this._outlineLabelOffsetResizeObserver?.disconnect(),null;if(globalThis.ResizeObserver){this._outlineLabelOffsetResizeObserver||=new globalThis.ResizeObserver(()=>{this._writeOutlinedLabelStyles(this._getOutlinedLabelOffset());});for(let e of this._prefixSuffixContainers())this._outlineLabelOffsetResizeObserver.observe(e,{box:"border-box"});}return this._getOutlinedLabelOffset();},write:e=>this._writeOutlinedLabelStyles(e())});}_shouldAlwaysFloat(){return this.floatLabel==="always";}_hasOutline(){return this.appearance==="outline";}_forceDisplayInfixLabel(){return!this._platform.isBrowser&&this._prefixChildren.length&&!this._shouldLabelFloat();}_hasFloatingLabel=ke(()=>!!this._labelChild());_shouldLabelFloat(){return this._hasFloatingLabel()?this._control.shouldLabelFloat||this._shouldAlwaysFloat():!1;}_shouldForward(e){let t=this._control?this._control.ngControl:null;return t&&t[e];}_getSubscriptMessageType(){return this._errorChildren&&this._errorChildren.length>0&&this._control.errorState?"error":"hint";}_handleLabelResized(){this._refreshOutlineNotchWidth();}_refreshOutlineNotchWidth(){!this._hasOutline()||!this._floatingLabel||!this._shouldLabelFloat()?this._notchedOutline?._setNotchWidth(0):this._notchedOutline?._setNotchWidth(this._floatingLabel.getWidth());}_processHints(){this._validateHints(),this._syncDescribedByIds();}_validateHints(){this._hintChildren;}_syncDescribedByIds(){if(this._control){let e=[];if(this._control.userAriaDescribedBy&&typeof this._control.userAriaDescribedBy=="string"&&e.push(...this._control.userAriaDescribedBy.split(" ")),this._getSubscriptMessageType()==="hint"){let o=this._hintChildren?this._hintChildren.find(l=>l.align==="start"):null,a=this._hintChildren?this._hintChildren.find(l=>l.align==="end"):null;o?e.push(o.id):this._hintLabel&&e.push(this._hintLabelId),a&&e.push(a.id);}else this._errorChildren&&e.push(...this._errorChildren.map(o=>o.id));let t=this._control.describedByIds,r;if(t){let o=this._describedByIds||e;r=e.concat(t.filter(a=>a&&!o.includes(a)));}else r=e;this._control.setDescribedByIds(r),this._describedByIds=e;}}_getOutlinedLabelOffset(){if(!this._hasOutline()||!this._floatingLabel)return null;if(!this._iconPrefixContainer&&!this._textPrefixContainer)return["",null];if(!this._isAttachedToDom())return null;let e=this._iconPrefixContainer?.nativeElement,t=this._textPrefixContainer?.nativeElement,r=this._iconSuffixContainer?.nativeElement,o=this._textSuffixContainer?.nativeElement,a=e?.getBoundingClientRect().width??0,l=t?.getBoundingClientRect().width??0,d=r?.getBoundingClientRect().width??0,c=o?.getBoundingClientRect().width??0,m=this._currentDirection==="rtl"?"-1":"1",f=`${a+l}px`,$=`calc(${m} * (${f} + var(--mat-mdc-form-field-label-offset-x, 0px)))`,ee=`var(--mat-mdc-form-field-label-transform, ${uc} translateX(${$}))`,Z=a+l+d+c;return[ee,Z];}_writeOutlinedLabelStyles(e){if(e!==null){let[t,r]=e;this._floatingLabel&&(this._floatingLabel.element.style.transform=t),r!==null&&this._notchedOutline?._setMaxWidth(r);}}_isAttachedToDom(){let e=this._elementRef.nativeElement;if(e.getRootNode){let t=e.getRootNode();return t&&t!==e;}return document.documentElement.contains(e);}static ɵfac=function(t){return new(t||i)();};static ɵcmp=v({type:i,selectors:[["mat-form-field"]],contentQueries:function(t,r,o){if(t&1&&(jr(o,r._labelChild,dn,5),He(o,ur,5)(o,sc,5)(o,lc,5)(o,ac,5)(o,mr,5)),t&2){Si();let a;E(a=D())&&(r._formFieldControl=a.first),E(a=D())&&(r._prefixChildren=a),E(a=D())&&(r._suffixChildren=a),E(a=D())&&(r._errorChildren=a),E(a=D())&&(r._hintChildren=a);}},viewQuery:function(t,r){if(t&1&&(Gr(r._iconPrefixContainerSignal,Na,5)(r._textPrefixContainerSignal,La,5)(r._iconSuffixContainerSignal,Va,5)(r._textSuffixContainerSignal,Ba,5),de(zl,5)(Na,5)(La,5)(Va,5)(Ba,5)(za,5)(Wa,5)(Ga,5)),t&2){Si(4);let o;E(o=D())&&(r._textField=o.first),E(o=D())&&(r._iconPrefixContainer=o.first),E(o=D())&&(r._textPrefixContainer=o.first),E(o=D())&&(r._iconSuffixContainer=o.first),E(o=D())&&(r._textSuffixContainer=o.first),E(o=D())&&(r._floatingLabel=o.first),E(o=D())&&(r._notchedOutline=o.first),E(o=D())&&(r._lineRipple=o.first);}},hostAttrs:[1,"mat-mdc-form-field"],hostVars:38,hostBindings:function(t,r){t&2&&A("mat-mdc-form-field-label-always-float",r._shouldAlwaysFloat())("mat-mdc-form-field-has-icon-prefix",r._hasIconPrefix)("mat-mdc-form-field-has-icon-suffix",r._hasIconSuffix)("mat-form-field-invalid",r._control.errorState)("mat-form-field-disabled",r._control.disabled)("mat-form-field-autofilled",r._control.autofilled)("mat-form-field-appearance-fill",r.appearance=="fill")("mat-form-field-appearance-outline",r.appearance=="outline")("mat-form-field-hide-placeholder",r._hasFloatingLabel()&&!r._shouldLabelFloat())("mat-primary",r.color!=="accent"&&r.color!=="warn")("mat-accent",r.color==="accent")("mat-warn",r.color==="warn")("ng-untouched",r._shouldForward("untouched"))("ng-touched",r._shouldForward("touched"))("ng-pristine",r._shouldForward("pristine"))("ng-dirty",r._shouldForward("dirty"))("ng-valid",r._shouldForward("valid"))("ng-invalid",r._shouldForward("invalid"))("ng-pending",r._shouldForward("pending"));},inputs:{hideRequiredMarker:"hideRequiredMarker",color:"color",floatLabel:"floatLabel",appearance:"appearance",subscriptSizing:"subscriptSizing",hintLabel:"hintLabel"},exportAs:["matFormField"],features:[ue([{provide:hr,useExisting:i},{provide:$a,useExisting:i}])],ngContentSelectors:Gl,decls:18,vars:21,consts:[["labelTemplate",""],["textField",""],["iconPrefixContainer",""],["textPrefixContainer",""],["textSuffixContainer",""],["iconSuffixContainer",""],[1,"mat-mdc-text-field-wrapper","mdc-text-field",3,"click"],[1,"mat-mdc-form-field-focus-overlay"],[1,"mat-mdc-form-field-flex"],["matFormFieldNotchedOutline","",3,"matFormFieldNotchedOutlineOpen"],[1,"mat-mdc-form-field-icon-prefix"],[1,"mat-mdc-form-field-text-prefix"],[1,"mat-mdc-form-field-infix"],[3,"ngTemplateOutlet"],[1,"mat-mdc-form-field-text-suffix"],[1,"mat-mdc-form-field-icon-suffix"],["matFormFieldLineRipple",""],["aria-atomic","true","aria-live","polite",1,"mat-mdc-form-field-subscript-wrapper","mat-mdc-form-field-bottom-align"],[1,"mat-mdc-form-field-error-wrapper"],[1,"mat-mdc-form-field-hint-wrapper"],["matFormFieldFloatingLabel","",3,"floating","monitorResize","id"],["aria-hidden","true",1,"mat-mdc-form-field-required-marker","mdc-floating-label--required"],[3,"id"],[1,"mat-mdc-form-field-hint-spacer"]],template:function(t,r){if(t&1&&(X(jl),We(0,Ul,1,1,"ng-template",null,0,Cn),u(2,"div",6,1),z("click",function(a){return r._control.onContainerClick(a);}),N(4,$l,1,0,"div",7),u(5,"div",8),N(6,ql,2,2,"div",9),N(7,Kl,3,0,"div",10),N(8,Zl,3,0,"div",11),u(9,"div",12),N(10,Jl,1,1,null,13),k(11),h(),N(12,ec,3,0,"div",14),N(13,tc,3,0,"div",15),h(),N(14,nc,1,0,"div",16),h(),u(15,"div",17),N(16,ic,2,0,"div",18)(17,oc,5,1,"div",19),h()),t&2){let o;p(2),A("mdc-text-field--filled",!r._hasOutline())("mdc-text-field--outlined",r._hasOutline())("mdc-text-field--no-label",!r._hasFloatingLabel())("mdc-text-field--disabled",r._control.disabled)("mdc-text-field--invalid",r._control.errorState),p(2),L(!r._hasOutline()&&!r._control.disabled?4:-1),p(2),L(r._hasOutline()?6:-1),p(),L(r._hasIconPrefix?7:-1),p(),L(r._hasTextPrefix?8:-1),p(2),L(!r._hasOutline()||r._forceDisplayInfixLabel()?10:-1),p(2),L(r._hasTextSuffix?12:-1),p(),L(r._hasIconSuffix?13:-1),p(),L(r._hasOutline()?-1:14),p(),A("mat-mdc-form-field-subscript-dynamic-size",r.subscriptSizing==="dynamic");let a=r._getSubscriptMessageType();p(),L((o=a)==="error"?16:o==="hint"?17:-1);}},dependencies:[za,Wa,Sn,Ga,mr],styles:[`.mdc-text-field {
  display: inline-flex;
...
`],encapsulation:2,changeDetection:0});}return i;})();var pc=["text"],fc=[[["mat-icon"]],"*"],gc=["mat-icon","*"];function _c(i,n){if(i&1&&W(0,"mat-pseudo-checkbox",1),i&2){let e=x();V("disabled",e.disabled)("state",e.selected?"checked":"unchecked");}}function bc(i,n){if(i&1&&W(0,"mat-pseudo-checkbox",3),i&2){let e=x();V("disabled",e.disabled);}}function vc(i,n){if(i&1&&(u(0,"span",4),j(1),h()),i&2){let e=x();p(),Ke("(",e.group.label,")");}}var fr=new g("MAT_OPTION_PARENT_COMPONENT"),gr=new g("MatOptgroup");var pr=class{source;isUserInput;constructor(n,e=!1){this.source=n,this.isUserInput=e;}},kt=(()=>{class i{_element=s(S);_changeDetectorRef=s(he);_parent=s(fr,{optional:!0});group=s(gr,{optional:!0});_signalDisableRipple=!1;_selected=!1;_active=!1;_mostRecentViewValue="";get multiple(){return this._parent&&this._parent.multiple;}get selected(){return this._selected;}value;id=s(pe).getId("mat-option-");get disabled(){return this.group&&this.group.disabled||this._disabled();}set disabled(e){this._disabled.set(e);}_disabled=Y(!1);get disableRipple(){return this._signalDisableRipple?this._parent.disableRipple():!!this._parent?.disableRipple;}get hideSingleSelectionIndicator(){return!!(this._parent&&this._parent.hideSingleSelectionIndicator);}onSelectionChange=new R();_text;_stateChanges=new C();constructor(){let e=s(ve);e.load(Ct),e.load(zi),this._signalDisableRipple=!!this._parent&&Lt(this._parent.disableRipple);}get active(){return this._active;}get viewValue(){return(this._text?.nativeElement.textContent||"").trim();}select(e=!0){this._selected||(this._selected=!0,this._changeDetectorRef.markForCheck(),e&&this._emitSelectionChangeEvent());}deselect(e=!0){this._selected&&(this._selected=!1,this._changeDetectorRef.markForCheck(),e&&this._emitSelectionChangeEvent());}focus(e,t){let r=this._getHostElement();typeof r.focus=="function"&&r.focus(t);}setActiveStyles(){this._active||(this._active=!0,this._changeDetectorRef.markForCheck());}setInactiveStyles(){this._active&&(this._active=!1,this._changeDetectorRef.markForCheck());}getLabel(){return this.viewValue;}_handleKeydown(e){(e.keyCode===13||e.keyCode===32)&&!ye(e)&&(this._selectViaInteraction(),e.preventDefault());}_selectViaInteraction(){this.disabled||(this._selected=this.multiple?!this._selected:!0,this._changeDetectorRef.markForCheck(),this._emitSelectionChangeEvent(!0));}_getTabIndex(){return this.disabled?"-1":"0";}_getHostElement(){return this._element.nativeElement;}ngAfterViewChecked(){if(this._selected){let e=this.viewValue;e!==this._mostRecentViewValue&&(this._mostRecentViewValue&&this._stateChanges.next(),this._mostRecentViewValue=e);}}ngOnDestroy(){this._stateChanges.complete();}_emitSelectionChangeEvent(e=!1){this.onSelectionChange.emit(new pr(this,e));}static ɵfac=function(t){return new(t||i)();};static ɵcmp=v({type:i,selectors:[["mat-option"]],viewQuery:function(t,r){if(t&1&&de(pc,7),t&2){let o;E(o=D())&&(r._text=o.first);}},hostAttrs:["role","option",1,"mat-mdc-option","mdc-list-item"],hostVars:11,hostBindings:function(t,r){t&1&&z("click",function(){return r._selectViaInteraction();})("keydown",function(a){return r._handleKeydown(a);}),t&2&&(ft("id",r.id),T("aria-selected",r.selected)("aria-disabled",r.disabled.toString()),A("mdc-list-item--selected",r.selected)("mat-mdc-option-multiple",r.multiple)("mat-mdc-option-active",r.active)("mdc-list-item--disabled",r.disabled));},inputs:{value:"value",id:"id",disabled:[2,"disabled","disabled",O]},outputs:{onSelectionChange:"onSelectionChange"},exportAs:["matOption"],ngContentSelectors:gc,decls:8,vars:5,consts:[["text",""],["aria-hidden","true",1,"mat-mdc-option-pseudo-checkbox",3,"disabled","state"],[1,"mdc-list-item__primary-text"],["state","checked","aria-hidden","true","appearance","minimal",1,"mat-mdc-option-pseudo-checkbox",3,"disabled"],[1,"cdk-visually-hidden"],["aria-hidden","true","mat-ripple","",1,"mat-mdc-option-ripple","mat-focus-indicator",3,"matRippleTrigger","matRippleDisabled"]],template:function(t,r){t&1&&(X(fc),N(0,_c,1,2,"mat-pseudo-checkbox",1),k(1),u(2,"span",2,0),k(4,1),h(),N(5,bc,1,1,"mat-pseudo-checkbox",3),N(6,vc,2,1,"span",4),W(7,"div",5)),t&2&&(L(r.multiple?0:-1),p(5),L(!r.multiple&&r.selected&&!r.hideSingleSelectionIndicator?5:-1),p(),L(r.group&&r.group._inert?6:-1),p(),V("matRippleTrigger",r._getHostElement())("matRippleDisabled",r.disabled||r.disableRipple));},dependencies:[Ya,$n],styles:[`.mat-mdc-option {
  -webkit-user-select: none;
  user-select: none;
  -moz-osx-font-smoothing: grayscale;
  -webkit-font-smoothing: antialiased;
...
`],encapsulation:2,changeDetection:0});}return i;})();var Ja=(()=>{class i{static ɵfac=function(t){return new(t||i)();};static ɵmod=M({type:i});static ɵinj=w({imports:[ln,_r,B,Mt,hi,_r]});}return i;})();function Rc(i,n){if(i&1&&(u(0,"mat-option",3),j(1),h()),i&2){let e=n.$implicit;V("value",e),p(),me(e);}}var fi=class i{days=[];value=null;valueChange=new R();static ɵfac=function(e){return new(e||i)();};static ɵcmp=v({type:i,selectors:[["app-day-filter"]],inputs:{days:"days",value:"value"},outputs:{valueChange:"valueChange"},decls:6,vars:1,consts:()=>{let n;n="Selecione o dia para exibir no mapa";let e;return e="Dia",[e,["appearance","outline",1,"day-filter-field"],["aria-label",n,3,"valueChange","value"],[3,"value"]];},template:function(e,t){e&1&&(u(0,"mat-form-field",1)(1,"mat-label"),Me(2,0),h(),u(3,"mat-select",2),z("valueChange",function(o){return t.valueChange.emit(o);}),vn(4,Rc,2,2,"mat-option",3,Br),h()()),e&2&&(p(3),V("value",t.value),p(),yn(t.days));},dependencies:[hi,ui,dn,Ja,Qa,kt],styles:[".day-filter-field[_ngcontent-%COMP%]{width:min(100%,220px);position:relative;top:10px}"],changeDetection:0});};var es={arcgisOAuth:{clientId:"IfpwEhcZQ8jITlsx",portalUrl:"https://portalgeo.eletrobras.com/portal",redirectUri:"https://iraolalabs.github.io/axia-poc/pt/",defaultBasemap:"dark-gray-vector",autoSaveWebMap:!1,newWebMapTitle:"New WebMap"}};var J=b({},es.arcgisOAuth);var _i={time:"Hor\xE1rio",windSpeed:"Velocidade do vento",windDirection:"Dire\xE7\xE3o do vento",source:"Origem"},un={lineName:"Nome da linha",installationCode:"C\xF3digo de instala\xE7\xE3o",nominalVoltage:"Tens\xE3o nominal",length:"Extens\xE3o",company:"Empresa"},ts={u10:"Componente U10",v10:"Componente V10",srid:"Refer\xEAncia espacial"},at={thresholdMs:"Limiar",thresholdKmh:"Limiar",windSpeedMax:"Velocidade m\xE1xima do vento",windSpeedMeanExceed:"Velocidade m\xE9dia excedida do vento",minimumArea:"\xC1rea m\xEDnima",smoothingBuffer:"Buffer de suaviza\xE7\xE3o",simplifyTolerance:"Toler\xE2ncia de simplifica\xE7\xE3o",srid:"Refer\xEAncia espacial"},ns=[107,114,128,.4],Fc=Lc(),Ot=class i{modulesPromise=null;mapView=null;homeWidget=null;webMap=null;windLayer=null;alertLayer=null;powerlineLayer=null;endpointLayer=null;spikeLayer=null;hasAppliedInitialExtent=!1;hasRenderedPowerlines=!1;hasAttemptedInitialSave=!1;async initialize(n,e){if(this.mapView)return;let t=await this.loadModules();this.webMap=new t.WebMap({basemap:J.defaultBasemap}),this.powerlineLayer=new t.GraphicsLayer({title:"Linhas de transmiss\xE3o"}),this.windLayer=new t.GraphicsLayer({title:"Vetores de vento"}),this.endpointLayer=new t.GraphicsLayer({title:"Extremidades da dire\xE7\xE3o do vento"}),this.spikeLayer=new t.GraphicsLayer({title:"Picos de vento"}),this.alertLayer=new t.GraphicsLayer({title:"Alert points"}),this.webMap.addMany([this.powerlineLayer,this.spikeLayer,this.windLayer,this.endpointLayer,this.alertLayer]),this.mapView=new t.MapView({container:n,map:this.webMap,center:[-55.29,-26.92],zoom:7,constraints:{snapToZoom:!1},popup:{dockEnabled:!0}}),this.homeWidget=new t.Home({view:this.mapView}),this.mapView.ui.add(this.homeWidget,"top-left"),J.autoSaveWebMap&&!this.hasAttemptedInitialSave&&(this.hasAttemptedInitialSave=!0,await this.saveNewWebMap(t,e));}async render(n){if(!this.mapView||!this.powerlineLayer||!this.windLayer||!this.endpointLayer||!this.spikeLayer||!this.alertLayer)return;let e=await this.loadModules(),t=this.alertLayer,r=n.powerlineFeatures.map(f=>new e.Graphic({geometry:{type:"polyline",paths:[f.coordinates],spatialReference:{wkid:4326}},symbol:{type:"simple-line",color:[37,99,235,.9],width:2,style:"solid"},attributes:Q(b({},gi(f.properties)),{featureId:f.id}),popupTemplate:{title:"Linha de transmiss\xE3o",content:Uc()}})),o=n.lineFeatures.map(f=>new e.Graphic({geometry:{type:"polyline",paths:[f.coordinates],spatialReference:{wkid:4326}},symbol:{type:"simple-line",color:ns,width:.9,style:"solid"},attributes:Q(b({},gi(f.properties)),{featureId:f.id}),popupTemplate:{title:"Vetor de vento",content:os()}})),a=n.lineFeatures.map(f=>{let I=ns;return new e.Graphic({geometry:{type:"point",longitude:f.endpoint[0],latitude:f.endpoint[1],spatialReference:{wkid:4326}},symbol:{type:"simple-marker",style:"triangle",color:I,size:4,angle:Wc(f.coordinates,f.properties.wd10),outline:{color:I,width:.35}},attributes:Q(b({},gi(f.properties)),{featureId:`${f.id}-endpoint`}),popupTemplate:{title:"Vetor de vento",content:os()}});}),l=[...n.polygonFeatures].sort((f,I)=>is(f.properties.wind_category)-is(I.properties.wind_category)).map(f=>{let I=Gc(f.properties.wind_category);return new e.Graphic({geometry:{type:"polygon",rings:f.rings,spatialReference:{wkid:4326}},symbol:{type:"simple-fill",color:I.fill,outline:{color:I.softEdge,width:2.5}},attributes:Q(b({},gi(f.properties)),{featureId:f.id}),popupTemplate:{title:"Pol\xEDgono de pico de vento",content:Hc()}});}),c=Bc(n.powerlineFeatures,n.timelineStepIndex).map(([f,I],$)=>new e.Graphic({geometry:{type:"point",longitude:f,latitude:I,spatialReference:{wkid:4326}},symbol:{type:"picture-marker",url:Fc,width:"40px",height:"40px"},attributes:{featureId:`alert-${$+1}`}}));this.windLayer.removeAll(),this.endpointLayer.removeAll(),this.spikeLayer.removeAll(),t.removeAll(),!this.hasRenderedPowerlines&&r.length>0&&(this.powerlineLayer.removeAll(),this.powerlineLayer.addMany(r),this.hasRenderedPowerlines=!0),l.length>0&&this.spikeLayer.addMany(l),o.length>0&&(this.windLayer.addMany(o),this.endpointLayer.addMany(a)),c.length>0&&t.addMany(c);let m=Tc(n,e.Extent);m&&this.homeWidget&&(this.homeWidget.viewpoint=m),!this.hasAppliedInitialExtent&&m&&(this.hasAppliedInitialExtent=!0,this.mapView.extent=m);}destroy(){this.mapView?.destroy(),this.mapView=null,this.homeWidget=null,this.webMap=null,this.powerlineLayer=null,this.windLayer=null,this.alertLayer=null,this.endpointLayer=null,this.spikeLayer=null,this.hasAppliedInitialExtent=!1,this.hasRenderedPowerlines=!1,this.hasAttemptedInitialSave=!1;}async saveNewWebMap(n,e){!this.webMap||e.status!=="authenticated"||(await this.webMap.saveAs(new n.PortalItem({title:J.newWebMapTitle}),{ignoreUnsupported:!0}));}loadModules(){return this.modulesPromise||(this.modulesPromise=(async()=>{let n=window.$arcgis;if(!n)throw new Error("O carregador CDN do ArcGIS n\xE3o est\xE1 dispon\xEDvel. Confirme que https://js.arcgis.com/5.0/ foi carregado em index.html.");let[e,t,r,o,a,l,d]=await Promise.all([n.import("@arcgis/core/WebMap.js"),n.import("@arcgis/core/views/MapView.js"),n.import("@arcgis/core/widgets/Home.js"),n.import("@arcgis/core/layers/GraphicsLayer.js"),n.import("@arcgis/core/Graphic.js"),n.import("@arcgis/core/geometry/Extent.js"),n.import("@arcgis/core/portal/PortalItem.js")]);return{WebMap:e,MapView:t,Home:r,GraphicsLayer:o,Graphic:a,Extent:l,PortalItem:d};})()),this.modulesPromise;}static ɵfac=function(e){return new(e||i)();};static ɵprov=_({token:i,factory:i.ɵfac});};function Tc(i,n){let e=i.lineFeatures.flatMap(a=>a.coordinates);if(e.length===0)return null;let t=e.map(([a])=>a),r=e.map(([,a])=>a),o=.18;return new n({xmin:Math.min(...t)-o,ymin:Math.min(...r)-o,xmax:Math.max(...t)+o,ymax:Math.max(...r)+o,spatialReference:{wkid:4326}});}function gi(i){return Object.fromEntries(Object.entries(i).map(([n,e])=>[n,Nc(e)]));}function Nc(i){if(typeof i=="number"&&Number.isFinite(i))return i.toFixed(2);if(typeof i=="string"){let n=i.trim();if(n!==""&&/^-?\d+(\.\d+)?$/.test(n)){let e=Number(n);if(Number.isFinite(e))return e.toFixed(2);}}return i;}function Lc(){let i=`
